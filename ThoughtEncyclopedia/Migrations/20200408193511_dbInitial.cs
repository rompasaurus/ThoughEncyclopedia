        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivacyValue = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KnowlegeTypeID = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: false),
                    CategoryId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateModified = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
                    ParentCommentIdCommentId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Comments_ParentCommentIdCommentId",
                        column: x => x.ParentCommentIdCommentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ParentCommentIdCommentId",
                table: "Comments",
                column: "ParentCommentIdCommentId");
